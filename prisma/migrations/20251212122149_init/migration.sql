...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('TASK_ASSIGNED', 'TASK_UPDATED', 'TASK_COMMENTED', 'SPRINT_STARTED', 'SPRINT_COMPLETED', 'MENTION', 'DUE_DATE_REMINDER', 'PROJECT_INVITATION', 'WORKSPACE_INVITATION');
...
-- CreateIndex
CREATE UNIQUE INDEX "projects_spaceId_key_key" ON "projects"("spaceId", "key");

-- CreateIndex
CREATE UNIQUE INDEX "project_members_projectId_userId_key" ON "project_members"("projectId", "userId");

-- CreateIndex
CREATE UNIQUE INDEX "tasks_projectId_key_key" ON "tasks"("projectId", "key");
